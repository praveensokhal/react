    ...
    return(
        ...
        <div class="container ">
            ...
            <div class="col-md-12">
                ...
                <p class="card-text myClass2 head"> Name : <small class="text-muted">{props.data?.name}</small> </p>
                ...
                <p class="card-text myClass2 head"> Total Amount : <small class="text-muted"> &#8377;{localStorage.total_price}</small> </p>
